...
<?php else: ?>
                        ...
                        <table class="table">
                            ...
                            <?php $__currentLoopData = $order_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($item->discounted_price > 0 ? $item->discounted_price : $item->price); ?></td>
    ...
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH /Users/ahmedmohy/Downloads/itargs_work/tawridco/admin_panel/resources/views/mail/order_status.blade.php ENDPATH**/ ?>