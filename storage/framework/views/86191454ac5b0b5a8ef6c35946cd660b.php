<?php
    use Carbon\Carbon;$appName = \App\Models\Setting::get_value('app_name');
...
<section class="invoice" id="printMe">
    <table width="100%">
        <tr>
            <td width="50%" style="text-align: left;"><h2><img src="<?php echo e($logo_full_path); ?>" height="45"> <?php echo e($appName); ?>

                </h2></td>
            <td width="50%" style="text-align: right;"><h2>Invoice</h2><h5 style="text-align: left;"><b>No
                        : </b>#<?php echo e($order->order_item_id); ?> </h5></td>
        </tr>
        <br>
        <tr>
    ...
    <div class="well">
        <table width="100%">
            <tr>
                ...
                <td width="50%" style="padding-left: 150px;">
                    <div>
                        <strong>
    ...
    <table width="100%">
        <tr>
            <td width="50%" style="text-align: left;">
                <p><span style="font-weight: bold;">Payment Method : </span> <?php echo e(strtoupper($order->payment_method)); ?>
            ...
            <td width="50%" style="text-align: right;">
                <table class="product-table">
                    ...
                    <tr>
                        <th align="left" style="padding: 8px; background-color: #37a279; color: white;">Final Total
                            (<?php echo e($currency); ?>)
                        </th>
                        <th align="right"
                            style="padding: 8px; background-color: #37a279; color: white;"><?php echo e('= ' . $order->final_total); ?></th>
                    </tr>
                    </tbody>
                </table>
            </td>
...
<?php /**PATH /Users/ahmedmohy/Downloads/itargs_work/tawridco/admin_panel/resources/views/invoiceMpdf.blade.php ENDPATH**/ ?>