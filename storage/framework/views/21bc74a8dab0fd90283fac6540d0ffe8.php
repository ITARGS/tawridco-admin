...
?>
    ...
    <!DOCTYPE html>
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" class="<?php echo e(app()->isLocale('ar') ? 'rtl' : 'ltr'); ?>">
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="csrf-token" content="<?php echo e(csrf_token()); ?>"/>

    <title><?php echo e($app_name??'Tawridco'); ?></title>
...
<?php /**PATH /Users/ahmedmohy/Downloads/itargs_work/tawridco/admin_panel/resources/views/welcome.blade.php ENDPATH**/ ?>