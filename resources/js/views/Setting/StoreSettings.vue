                          ...
                          <div class="row">
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-4">
                                  ...
                                  <input
                                    ...
                                    name="fssai_lic_img"
                                    id="fssai_lic_img"
                                    v-on:change="handleFssaiLicImgUpload"
                                    ref="fssai_lic_img"
                                    accept="image/*"
                                    class="file-input"
                                  />
                                  <div
                                    class="file-input-div"
                                    @click="$refs.fssai_lic_img.click()"
                                    @drop="dropFileFssaiLicImg"
                                    @dragover="$dragoverFile"
                                    @dragleave="$dragleaveFile"
                                  >
                                    ...
                                    <template
                                      v-if="
                                        fssai_lic_img_name && fssai_lic_img_name !== ''
                                      "
                                    >
                                      <label
                                        >{{ __("selected_file_name") }}
                                        {{ fssai_lic_img_name }}</label
                                      >
                                    </template>
                                    <template v-else>
                                      <label
                                ...
                                <div class="col-md-4">
                                  <label for="panel_login_background_img">{{
                                    __("panel_login_background_img")
                                  }}</label>
                                  <input
                                    type="file"
                                    name="panel_login_background_img"
                                    id="panel_login_background_img"
                                    v-on:change="handlePanelLoginBackgroundImgUpload"
                                  ...
                                  <div
                                    class="file-input-div"
                                    @click="$refs.panel_login_background_img.click()"
                                    @drop="dropFile"
                                    @dragover="$dragoverFile"
                                    @dragleave="$dragleaveFile"
                                  >
                                    <span
                                      ...
                                      class="error"
                                      >{{ Panel_login_background_imgerror }}</span
                                    >
                                    <template
                                      v-if="
                                    ...
                                    >
                                      <label>
                                        {{ __("selected_file_name")
                                        }}{{ panel_login_background_img_name }}</label
                                      >
                                    </template>
                                    <template v-else>
                                      <label
                            ...
                            <div class="form-group col-md-4">
                              ...
                              <textarea
                                ...
                                v-model="store_settings.copyright_details"
                                rows="4"
                                cols="70"
                                class="form-control"
                          ...
                          <div class="row">
                            <div class="form-group col-md-4">
                              ...
                              <textarea
                                ...
                                id="store_address"
                                rows="2"
                                v-model="store_settings.store_address"
                              ></textarea>
                            </div>
                            <div class="form-group col-md-4">
                            ...
                            <div class="form-group col-md-4">
                              <label class="system_timezone" for="system_timezone">{{
                                __("system_timezone")
                              }}</label>
                              <select
                          ...
                          <div class="row">
                            <div class="form-group col-md-4">
                              <label for="max_cart_items_count">
                                {{ __("maximum_items_allowed_in_cart") }}
                              </label>
                              <i class="text-danger">*</i>
                              <input
                                type="number"
                      ...
                      <div class="card-body">
                        ...
                        >
                          <div class="row">
                            ...
                            <div
                              v-if="store_settings.delivery_boy_bonus_settings == 1"
                              class="form-group col-md-4"
                            >
                              <label for="delivery_boy_bonus_type">{{
                                __("bonus_type")
                              }}</label>
                              <select
                              ...
                              >
                                ...
                                <option value="0">
                                  {{ __("fixed") }}/{{ __("salaried") }}
                                </option>
                              </select>
                            </div>
                            <div
                              v-if="
                                store_settings.delivery_boy_bonus_settings == 1 &&
                                store_settings.delivery_boy_bonus_type == 1
                              "
                              class="form-group col-md-4"
                            >
                          ...
                          <div class="row">
                            <div class="form-group col-md-4">
                              <label for="generate_otp">{{
                                __("Order Delivery OTP System")
                              }}</label
                              ><br />
                              <div class="form-check form-switch">
                                <input
                    ...
                    <div class="card">
                      ...
                      <div class="card-body">
                        ...
                        >
                          <div class="row">
                            <div class="form-group col-md-4">
                              <label for="app_mode_customer"
                                >{{ __("customer_app") }}
                                <span class="text text-primary font-size-13"
                                  >( {{ __("enable") }}/{{ __("disable") }} )</span
                                ></label
                              ><br />
                              <div class="form-check form-switch">
                                <input
                            ...
                            <div class="form-group col-md-4">
                              <label for="playstore_url">{{ __("playstore_url") }}</label
                              ><br />
                              <input
                                type="url"
                                class="form-control"
                            ...
                            <div class="form-group col-md-4">
                              <label for="appstore_url">{{ __("appstore_url") }}</label
                              ><br />
                              <input
                                type="url"
                                class="form-control"
                        ...
                        >
                          <div class="row">
                            <div class="form-group col-md-6">
                              <label for=""
                                >{{
                                  __("display_category_section_in_home_page")
                                }}? </label
                              ><br />
                              <div class="form-check form-switch">
                                <input
                              ...
                              >
                                <input
                                  ...
                                  :min="1"
                                  :required="
                                    store_settings.is_category_section_in_homepage == 1
                                  "
                                  v-model="
                            ...
                            <div class="form-group col-md-6">
                              <label for=""
                                >{{ __("display_brand_section_in_home_page") }}? </label
                              ><br />
                              <div class="form-check form-switch">
                                <input
                                  type="checkbox"
                              ...
                              >
                                <input
                                  ...
                                  :min="1"
                                  :required="
                                    store_settings.is_brand_section_in_homepage == 1
                                  "
                                ...
                                <span v-if="validationBrandError" class="error">{{
                                  validationBrandError
                                }}</span>
                              </div>
                            </div>
                            <div class="form-group col-md-6">
                              <label for=""
                                >{{ __("display_seller_section_in_home_page") }}?</label
                              ><br />
                              <div class="form-check form-switch">
                                <input
                                  type="checkbox"
                              ...
                              >
                                <input
                                  ...
                                  :min="1"
                                  :required="
                                    store_settings.is_seller_section_in_homepage == 1
                                  "
                                  v-model="
                                ...
                                <span v-if="validationSellerError" class="error">{{
                                  validationSellerError
                                }}</span>
                              </div>
                            </div>
                            <div class="form-group col-md-6">
                              <label for=""
                                >{{ __("display_country_section_in_home_page") }}? </label
                              ><br />
                              <div class="form-check form-switch">
                                <input
                                  type="checkbox"
                              ...
                              >
                                <input
                                  ...
                                  :min="1"
                                  :required="
                                    store_settings.is_country_section_in_homepage == 1
                                  "
                                  v-model="
                    ...
                    <div class="card">
                      ...
                      <div class="card-body">
                        ...
                        >
                          <div class="row">
                            <div class="form-group col-md-4">
                              <label for="smtp_from_mail"
                                >{{ __("from_email_id") }}:</label
                              >
                              <input
                                type="text"
                                class="form-control"
                            ...
                            <div class="form-group col-md-3">
                              ...
                              >
                                <option value="">
                                  {{ __("select_smtp_email_content_tpe") }}
                                </option>
                            ...
                            <div class="form-group col-md-2">
                              <label for="smtp_encryption_type"
                                >{{ __("smtp_encryption") }}:
                              </label>
                              <select
                              ...
                              >
                                <option value="">
                                  {{ __("select_smtp_encryption_type") }}
                                </option>
                          ...
                          <div class="row">
                            ...
                            <div class="form-group col-md-4">
                              ...
                              <p>
                                {{ __("test_mail_for_test_your_smtp_configuration") }}
                              </p>
                            </div>
                          </div>
                          <div class="row">
                      ...
                      <div class="card-body" v-if="$isDemo != 1">
                        ...
                        >
                          <div class="row -align-items-center">
                            <div class="form-group col-md-4">
                              <label for="google_place_api_key">{{
                                __("place_api_key")
                              }}</label>
                              <input
                                type="text"
                      ...
                      <div class="card-body">
                        ...
                        >
                          <div class="row">
                            ...
                            <div
                              v-if="login_settings.phone_login == '1'"
                              class="form-group col-md-4"
                            >
                          ...
                          <div class="row">
                            ...
                            >
                              ...
                              <div class="input-group">
                                <div class="input-group-prepend">
                                  <div
                                    class="input-group-text myDivClass"
                                    style="height: 42px"
                                  >
                            ...
                            >
                              <label for="notification_interval">
                                {{ __("notification_interval") }}</label
                              >
                              <i class="text-danger">* </i
                              ><i class="fa fa-question-circle tooltip-icon">
                                <span class="tooltip-text">{{
                            ...
                            >
                              <label for="notification_stop_time">
                                {{ __("notification_stop_time") }}</label
                              >
                              <i class="text-danger">* </i
                              ><i class="fa fa-question-circle tooltip-icon">
                                <span class="tooltip-text">{{
                                  __("notification_stop_time_tooltip")
                                }}</span></i
                              >
                              <div class="input-group">
                                <div class="input-group-prepend">
...
export default {
  ...
  data: function () {
    return {
      ...
      tabs: [
        ...
        __("address_setting"),
        __("other_setting"),
        __("delivery_boy_setting"),
        __("app_setting"),
        __("frontend_home_setting"),
        __("smtp_mail_setting"),
        __("google_place_apis"),
        __("seller_setting"),
        __("login_setting"),
        __("cart_setting"),
      ],
  ...
  methods: {
    ...
    handlePanelLoginBackgroundImgUpload: function () {
      ...
      this.panel_login_background_img_url = URL.createObjectURL(
        this.store_settings.panel_login_background_img
      );
      this.panel_login_background_img_name = this.store_settings.panel_login_background_img.name;
    },
    validateInput() {
      const count_category_section_in_homepage = this.store_settings
      ...
      const count_brand_section_in_homepage = this.store_settings
      ...
      const count_seller_section_in_homepage = this.store_settings
      ...
      const count_country_section_in_homepage = this.store_settings
    ...
    setCityId() {
      this.store_settings.default_city_id =
    ...
    getStoreSetting() {
      ...
      axios.get(url).then((response) => {
        ...
        if (this.store_settings.panel_login_background_img != "") {
          this.panel_login_background_img_url =
            this.$storageUrl + this.store_settings.panel_login_background_img;
        } else {
          this.panel_login_background_img_url =
            this.$baseUrl + "/images/panel_login_background_img.png";
        }
        if (this.store_settings.copyright_details != "") {
          this.store_settings.copyright_details = this.store_settings.copyright_details.replace(
            /<br\s*\/?>/g,
            "\n"
          );
        }
