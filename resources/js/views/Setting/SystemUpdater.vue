        ...
        <div class="col-6 col-md-6 order-md-1 order-last">
          <div class="card" v-if="updaterResult && updaterResult.description">
            <div class="card-header">
              <h4>
                {{ __("change_logs_of_egrocer") }} {{ "v - " + updaterResult.version }}
              </h4>
              <span class="pull-right">
                <span class="badge bg-primary">
                  {{ __("new_update_available")
                  }}<span class="badge rounded-pill bg-success text-white ms-1">{{
                    "v - " + updaterResult.version
                  }}</span>
                </span>
              </span>
            </div>
