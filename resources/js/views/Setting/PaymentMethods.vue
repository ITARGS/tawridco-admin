          ...
          <div class="row">
              ...
              <div class="card h-100">
                ...
                <div class="card-body">
                  <input
                    ...
                    v-model="payment_method.payment_method_settings"
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-check form-switch">
                        <input
                          ...
                          true-value="1"
                          false-value="0"
                          v-model="payment_method.cod_payment_method"
                          :checked="payment_method.cod_payment_method"
                        />
                      </div>
                    </div>
                    <div v-if="payment_method.cod_payment_method == 1" class="form-group">
                      <label for="cod_mode">{{ __("cod_mode") }}</label
                      ><br />
                      <p>
                        <small
                          ><b>{{ __("global") }} :</b>
                          {{ __("will_be_considered_for_all_the_products") }}.</small
                        >
                      </p>
                      <p>
                        <small
                          ><b>{{ __("product_wise") }} :</b>
                          {{ __("product_wise_cod_will_be_considered") }}.</small
                        >
                      </p>
                      <select
                        name="cod_mode"
                        ...
                        v-model="payment_method.cod_mode"
                      >
            ...
            <div class="col-6 mb-4">
              <div class="card h-100">
                ...
                <div class="card-body">
                  <div class="form-group">
                    <label for="paypal_payment_method">
                      {{ __("paypal_payments")
                      }}<small
                        >[ {{ __("enable") }} / {{ __("disable") }} ]
                      </small></label
                    ...
                    <div class="form-check form-switch">
                      <input
                        ...
                        true-value="1"
                        false-value="0"
                        v-model="payment_method.paypal_payment_method"
                        :checked="payment_method.paypal_payment_method"
                      />
                    </div>
                  </div>
                  <div
                    v-if="payment_method.paypal_payment_method == 1"
                    class="form-group"
                  >
                    <label for="paypal_mode">
                      {{ __("payment_mode")
                      }}<small>[ {{ __("sandbox") }} / {{ __("live") }} ]</small></label
                    >
                    <select
                      name="paypal_mode"
                      id="paypal_mode"
                      required
                      v-model="payment_method.paypal_mode"
                      class="form-control form-select"
                    >
                      <option value="">{{ __("select_mode") }}</option>
                      <option value="sandbox" selected="">
                        {{ __("sandbox") }} ( {{ __("testing") }} )
                      </option>
                      <option value="production">
                        {{ __("production") }}( {{ __("live") }} )
                      </option>
                    </select>
                  </div>
                  <div
                  ...
                  >
                    <label for="paypal_currency_code"
                      >{{ __("currency_code") }}
                      <small>[ {{ __("paypal_supported") }} ]</small>
                      <a
                    ...
                    <select
                      ...
                      required
                      v-model="payment_method.paypal_currency_code"
                      class="form-control form-select"
                    >
            ...
            <div class="col-6 mb-4">
              <div class="card h-100">
                ...
                <div class="card-body">
                  <div class="form-group">
                    <label for="stripe_payment_method"
                      >{{ __("stripe_payments") }}
                      <small>[ {{ __("enable") }} / {{ __("disable") }} ] </small></label
                    ><br />
                    <div class="form-check form-switch">
                      <input
                        class="form-check-input"
                        ...
                        true-value="1"
                        false-value="0"
                        v-model="payment_method.stripe_payment_method"
                        :checked="payment_method.stripe_payment_method"
                      />
                    </div>
                  </div>
                  <div
                    v-if="payment_method.stripe_payment_method == 1"
                    class="form-group"
                  >
                  ...
                  >
                    <label for="stripe_webhook_url"
                      >{{ __("payment_endpoint_url") }}
                      <small
                        >({{ __("set_this_as_url_in_your_stripe_account") }})</small
                      ></label
                    >
                    <input
                      type="text"
                      ...
                      v-model="payment_method.stripe_webhook_url"
                      readonly=""
                    />
                  </div>
                  <div
                  ...
                  >
                    <label for="stripe_currency_code"
                      >{{ __("currency_code") }}
                      <small>[ {{ __("stripe_supported") }}]</small>
                    ...
                    <select
                      ...
                      required
                      v-model="payment_method.stripe_currency_code"
                      class="form-control form-select"
                    >
                  ...
                  >
                    ...
                    <select
                      ...
                      id="stripe_mode"
                      class="form-control form-select"
                      :required="payment_method.stripe_payment_method == 1"
                      v-model="payment_method.stripe_mode"
                    >
                      <option value="">{{ __("select_mode") }}</option>
            ...
            <div class="col-6 mb-4">
              <div class="card h-100">
                ...
                <div class="card-body">
                  <div class="form-group">
                    <label for="paytm_payment_method"
                      >{{ __("paytm_payments")
                      }}<small
                        >[ {{ __("enable") }} / {{ __("disable") }} ]
                      </small></label
                    ...
                    <div class="form-check form-switch">
                      <input
                        ...
                        true-value="1"
                        false-value="0"
                        v-model="payment_method.paytm_payment_method"
                        :checked="payment_method.paytm_payment_method"
                      />
                    </div>
                  </div>

                  <div v-if="payment_method.paytm_payment_method == 1" class="form-group">
                    <label for="paytm_mode"
                      >{{ __("paytm_payment_mode") }}
                      <small>[ {{ __("sandbox") }} / {{ __("live") }} ]</small></label
                    >
                    <select
                      name="paytm_mode"
                      id="paytm_mode"
                      :required="payment_method.paytm_payment_method == 1"
                      v-model="payment_method.paytm_mode"
                      class="form-control form-select"
                    >
                  ...
                  <div v-if="payment_method.paytm_payment_method == 1" class="form-group">
                    ...
                    <input
                      ...
                      v-model="payment_method.paytm_merchant_key"
                  ...
                  <div v-if="payment_method.paytm_payment_method == 1" class="form-group">
                    ...
                    <input
                      ...
                      v-model="payment_method.paytm_merchant_id"
            ...
            <div class="col-6 mb-4">
              <div class="card h-100">
                ...
                <div class="card-body">
                  <div class="form-group">
                    <label for="midtrans_payment_method"
                      >{{ __("midtrans_payments")
                      }}<small
                        >[ {{ __("enable") }} / {{ __("disable") }} ]
                      </small></label
                    ><br />
                    <div class="form-check form-switch">
                      <input
                        ...
                        true-value="1"
                        false-value="0"
                        v-model="payment_method.midtrans_payment_method"
                        :checked="payment_method.midtrans_payment_method"
                      />
                    </div>
                  </div>

                  <div
                    v-if="payment_method.midtrans_payment_method == 1"
                    class="form-group"
                  >
                    <label for="midtrans_mode"
                      >{{ __("midtrans_payment_mode") }}
                      <small>[ {{ __("sandbox") }} / {{ __("live") }} ]</small></label
                    >
                    <select
                      name="midtrans_mode"
                      id="midtrans_mode"
                      :required="payment_method.midtrans_payment_method == 1"
                      v-model="payment_method.midtrans_mode"
                      class="form-control form-select"
                    >
                      <option value="">{{ __("select_mode") }}</option>
                      <option value="sandbox">
                  ...
                  >
                    ...
                    <input
                      ...
                      v-model="payment_method.midtrans_server_key"
                  ...
                  >
                    <label for="paypal_notification_url"
                      >{{ __("notification_url") }}
                      <small>{{ __("set_webhook_url") }}</small></label
                    >
                    <input
                      type="text"
                      class="form-control"
                      name="midtrans_notification_url"
                      v-model="payment_method.midtrans_notification_url"
                  ...
                  >
                    ...
                    <input
                      ...
                      v-model="payment_method.midtrans_return_url"
            ...
            <div class="col-6 mb-4">
              <div class="card h-100">
                ...
                <div class="card-body">
                  <div class="form-group">
                    <label for="phonepay_payment_method"
                      >{{ __("phonepay_payments")
                      }}<small
                        >[ {{ __("enable") }} / {{ __("disable") }} ]
                      </small></label
                    ><br />
                    <div class="form-check form-switch">
                      <input
                        ...
                        true-value="1"
                        false-value="0"
                        v-model="payment_method.phonepay_payment_method"
                        :checked="payment_method.phonepay_payment_method"
                      />
                    </div>
                  </div>

                  <div
                    v-if="payment_method.phonepay_payment_method == 1"
                    class="form-group"
                  >
                    <label for="phonepay_mode"
                      >{{ __("phonepay_payment_mode") }}
                      <small>[ {{ __("sandbox") }} / {{ __("live") }} ]</small></label
                    >
                    <select
                      name="phonepay_mode"
                      id="phonepay_mode"
                      :required="payment_method.phonepay_payment_method == 1"
                      v-model="payment_method.phonepay_mode"
                      class="form-control form-select"
                    >
                      <option value="">{{ __("select_mode") }}</option>
                      <option value="sandbox">
                  ...
                  >
                    ...
                    <input
                      ...
                      id="phonepay_api_key"
                      v-model="payment_method.phonepay_api_key"
                  ...
                  >
                    ...
                    <input
                      ...
                      v-model="payment_method.phonepay_merchant_id"
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <div class="form-check form-switch">
                      <input
                        ...
                        true-value="1"
                        false-value="0"
                        v-model="payment_method.cashfree_payment_method"
                        :checked="payment_method.cashfree_payment_method"
                      />
                    </div>
                  </div>
                  <div
                    v-if="payment_method.cashfree_payment_method == 1"
                    class="form-group"
                  >
                    <label for="cashfree_mode"
                      >{{ __("cashfree_payment_mode") }}
                      <small>[ {{ __("sandbox") }} / {{ __("live") }} ]</small></label
                    >
                    <select
                      name="cashfree_mode"
                      id="cashfree_mode"
                      :required="payment_method.cashfree_payment_method == 1"
                      v-model="payment_method.cashfree_mode"
                      class="form-control form-select"
                    >
                      <option value="">{{ __("select_mode") }}</option>
                      <option value="sandbox">
                  ...
                  >
                    ...
                    <input
                      ...
                      id="cashfree_app_id"
                      v-model="payment_method.cashfree_app_id"
                  ...
                  >
                    ...
                    <input
                      ...
                      v-model="payment_method.cashfree_secret_key"
                  ...
                  <div
                    ...
                    class="form-group"
                  >
                    <label for="cashfree_notification_url"
                      >{{ __("notification_url") }}
                      <small>{{ __("set_webhook_url_for_cashfree") }}</small></label
                    >
                    <input
                      type="text"
                      class="form-control"
                      name="cashfree_notification_url"
                      v-model="payment_method.cashfree_notification_url"
            ...
            <div class="col-6 mb-4">
              <div class="card h-100">
                ...
                <div class="card-body">
                  <div class="form-group">
                    <label for="paytabs_payment_method"
                      >{{ __("paytabs_payments")
                      }}<small
                        >[ {{ __("enable") }} / {{ __("disable") }} ]
                      </small></label
                    ...
                    <div class="form-check form-switch">
                      <input
                        ...
                        true-value="1"
                        false-value="0"
                        v-model="payment_method.paytabs_payment_method"
                        :checked="payment_method.paytabs_payment_method"
                      />
                    </div>
                  </div>
                  <div
                    v-if="payment_method.paytabs_payment_method == 1"
                    class="form-group"
                  >
                    <label for="paytabs_mode"
                      >{{ __("paytabs_payment_mode") }}
                      <small>[ {{ __("sandbox") }} / {{ __("live") }} ]</small></label
                    >
                    <select
                      name="paytabs_mode"
                      id="paytabs_mode"
                      :required="payment_method.paytabs_payment_method == 1"
                      v-model="payment_method.paytabs_mode"
                      class="form-control form-select"
                    >
                      <option value="">{{ __("select_mode") }}</option>
                      <option value="sandbox">
                  ...
                  <div
                    ...
                    class="form-group"
                  >
                    <label for="paytabs_notification_url"
                      >{{ __("notification_url") }}
                      <small>{{ __("set_webhook_url_for_paytabs") }}</small></label
                    >
                    <input
                      type="text"
                      class="form-control"
            ...
            <div class="form-group">
              <b-button
                ...
                variant="primary"
                :disabled="isLoading"
                v-if="$can('manage_payment_methods')"
              >
                {{ __("update") }}
...
export default {
  ...
  methods: {
    getPaymentMethods() {
      axios.get(this.$apiUrl + "/payment_methods").then((response) => {
        if (response.data.data) {
          ...
          this.payment_method.payment_method_settings =
            this.record.payment_method_settings ?? 0;
          ...
          this.payment_method.paypal_currency_code =
            this.record.paypal_currency_code ?? "";
          this.payment_method.paypal_business_email = this.record.paypal_business_email;
          this.payment_method.paypal_notification_url =
            this.record.paypal_notification_url ?? "";
          ...
          this.payment_method.paystack_currency_code =
            this.record.paystack_currency_code ?? "";
          ...
          this.payment_method.flutterwave_currency_code =
            this.record.flutterwave_currency_code ?? "";
    ...
    saveRecord: function () {
      ...
      let vm = this;
      if (
        this.payment_method.cod_payment_method == 1 ||
