      ...
      <div class="row">
        ...
        <div class="form-group col-md-6">
          ...
          <input
            ...
            v-model="section.short_description"
            class="form-control"
            :placeholder="__('ex_here')"
            required
          />
        </div>
        ...
        <div class="form-group col-md-3">
          ...
          >
            ...
            <option value="most_selling_products">
              {{ __("most_selling_products") }}
            </option>
        ...
        <div class="form-group col-md-3">
          ...
          >
            ...
            <option value="below_shop_by_country_of_origin">
              {{ __("below_shop_by_country_of_origin") }}
            </option>
            <option value="custom_below_shop_by_brands">
              {{ __("below_shop_by_brands") }}
            </option>
          </select>
        </div>
        <div class="form-group col-md-3">
          <label for="background color (Light theme)">{{
            __("background_color_for_light_theme")
          }}</label>
        ...
        <div class="form-group col-md-3">
          <label for="background color (Dark theme)">{{
            __("background_color_for_dark_theme")
          }}</label>
          <i class="text-danger">*</i>
          <b-input-group prepend class="mb-2">
            <input
        ...
        <div class="col-md-6 form-group">
          ...
          <div class="form-group" v-if="section.style_app === 'style_4'">
            <label for="banner_app"
              >{{ __("banner_image") }}<i class="text-danger">*</i></label
            >
            ...
            <input
              ...
              accept="image/*"
              id="banner_app"
              @change="handleFileUploadBannerApp"
              ref="file_banner_app"
              class="file-input"
            />
            ...
            <div
              ...
              @click="$refs.file_banner_app.click()"
              @drop="dropFile"
            ...
            >
              <template v-if="section.banner_app && section.banner_app.name !== ''">
                <label>
                  {{ __("selected_file_name") }} {{ section.banner_app.name }}</label
                >
              </template>
              <template v-else>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-3 col-sm-3">
              <label class="radio-img">
                ...
                <img
                  :src="$baseUrl + '/images/web_style/Web_Style_2.jpg'"
                  alt="style_2"
                  class="style_image"
                />
              </label>
            ...
            <div class="col-md-3 col-sm-3">
              <label class="radio-img">
                ...
                <img
                  :src="$baseUrl + '/images/web_style/Web_Style_3.jpg'"
                  alt="style_3"
                  class="style_image"
                />
              </label>
            ...
            <div class="col-md-3 col-sm-3">
              <label class="radio-img">
                ...
                <img
                  :src="$baseUrl + '/images/web_style/Web_Style_4.jpg'"
                  alt="style_4"
                  class="style_image"
                />
              </label>
          ...
          <div class="form-group row" v-if="section.style_web === 'style_4'">
            <div class="col-md-12">
              ...
              <input
                ...
                accept="image/*"
                id="banner_web"
                @change="handleFileUploadBannerWeb"
                ref="file_banner_web"
                class="file-input"
              />
              <div
                class="file-input-div bg-gray-100 mt-2"
                @click="$refs.file_banner_web.click()"
                @drop="dropFileWeb"
                @dragover="$dragoverFile"
                @dragleave="$dragleaveFile"
              >
                <template v-if="section.banner_web && section.banner_web.name !== ''">
                  <label>
                    {{ __("selected_file_name") }} {{ section.banner_web.name }}</label
                  >
                </template>
                <template v-else>
                  <label><i class="fa fa-cloud-upload-alt fa-2x"></i></label>
...
export default {
  ...
  data: function () {
    return {
      ...
      section: {
        ...
        category_ids:
          this.record && this.record.category_ids
            ? this.record.category_ids.split(",")
            : "",
        product_type: this.record ? this.record.product_type : "",
        product_ids:
          this.record && this.record.product_ids
            ? this.record.product_ids.split(",")
            : "",
        ...
        background_color_for_light_theme: this.record
          ? this.record.background_color_for_light_theme
          : "",
        background_color_for_dark_theme: this.record
          ? this.record.background_color_for_dark_theme
          : "",
  ...
  methods: {
    ...
    getProducts() {
      this.isLoading = true;
      axios
        .get(this.$apiUrl + "/products/active")
        .then((response) => {
          this.isLoading = false;
