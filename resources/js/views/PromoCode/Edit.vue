  ...
  >
    <div slot="modal-footer">
      <b-button
        ...
        :disabled="isLoading || Number(this.minimum_order_amount) < Number(this.discount)"
      >
        {{ __("save") }}
    ...
    <form ref="my-form" @submit.prevent="saveRecord">
      ...
      <div class="row">
        <label
          ><span class="text-danger text-xs">*</span> {{ __("required_fields") }}</label
        >
        <div class="divider mt-0">
          <div class="divider-text">{{ __("promo_code_form") }}</div>
        </div>
        ...
        <div class="form-group col-md-6">
          ...
          <input
            ...
            class="form-control"
            v-model="start_date"
            :placeholder="__('enter_date')"
            @input="validateStartDate"
          />
          <span v-if="validationStartDateError" class="error">{{
        ...
        <div class="form-group col-md-6" v-if="discount_type != ''">
          ...
          <input
            ...
            v-model="discount"
            :placeholder="__('enter_percentage')"
          ...
          />
          <p v-if="discountPercentagevalidationError" class="error">
            {{ discountPercentagevalidationError }}
          </p>
        </div>
        ...
        <div class="form-group col-md-6">
          ...
          <input
            ...
            :placeholder="__('enter_max_discount_amount')"
            @input="validateMaxDiscountAmount"
          />
          <span v-if="validationMaxDiscountAmountError" class="error">{{
            validationMaxDiscountAmountError
          }}</span>
        </div>
        <div class="form-group col-md-6">
        ...
        >
          ...
          <input
            ...
            :placeholder="__('enter_user')"
          />
          <span class="text text-primary font-size-13">{{
            __("set_0_if_you_want_ro_remove_limit")
          }}</span>
        </div>
...
export default {
  ...
  data: function () {
    return {
      ...
      discount_type:
        this.record && this.record.length !== 0 ? this.record.discount_type : "",
  ...
  methods: {
    ...
    validateStartDate() {
      ...
      if (startDate < currentDate || startDate > endDate) {
        this.validationStartDateError =
          "Start date cannot be a past date or after the end date.";
        this.start_date = "";
      } else {
