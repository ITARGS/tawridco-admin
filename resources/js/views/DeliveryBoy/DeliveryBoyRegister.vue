          ...
          <div class="content">
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label for="email"
                    >{{ __("email") }} <span class="text-danger text-xs">*</span></label
                  >
                  <input
                    type="email"
                    name="email"
                ...
                <div class="form-group">
                  ...
                  <div class="row" v-if="deliveryBoys.driving_license_url">
                    ...
                    <div v-else class="col-md-2 mt-2">
                      ...
                      >
                        <i class="fa fa-eye"></i> {{ __("driving_licence") }}</a
                      >
                    </div>
                  </div>
                </div>
...
export default {
  ...
  methods: {
    ...
    validateMobileNumber() {
      ...
      if (!mobileRegex.test(this.deliveryBoys.mobile)) {
        this.mobilevalidationError =
          "Mobile Number must be numeric and should not exceed 16 digits.";
    ...
    validateCommission() {
      if (
        this.deliveryBoys.bonus_percentage < 1 ||
        this.deliveryBoys.bonus_percentage > 100
      ) {
    ...
    getCities() {
      this.isLoading = true;
      axios.get(this.$deliveryBoyApiUrl + "/cities").then((response) => {
