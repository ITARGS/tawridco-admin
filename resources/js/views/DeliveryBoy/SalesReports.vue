            ...
            >
              <ol class="breadcrumb">
                <li class="breadcrumb-item">
                  <router-link to="/delivery_boy/dashboard">{{
                    __("dashboard")
                  }}</router-link>
                </li>
          ...
          <div class="card-body">
            <b-row class="mb-2">
              ...
              <b-col md="3">
                ...
                >
                  <option value="">{{ __("select_categories") }}</option>
            ...
            <b-row>
              <div class="col-md-4 text-success h6">
                {{ __("total_amount") }} :- {{ $currency }} {{ final_total_sum }}
              </div>
            </b-row>
            <b-row>
...
export default {
  ...
  methods: {
    getSalesReports() {
      ...
      axios
        .get(this.$deliveryBoyApiUrl + "/sales_reports", {
          params: param,
        })
        .then((response) => {
          ...
          this.final_total_sum = this.salesReports
