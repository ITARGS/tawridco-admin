            ...
            >
              ...
              <template #cell(actions)="row">
                <button
                  ...
                  v-if="$can('return_request_update')"
                  v-b-tooltip.hover
                  :title="__('edit')"
                >
                ...
                <button
                  ...
                  v-if="$can('return_request_delete')"
                  v-b-tooltip.hover
                  :title="__('delete')"
                >
...
export default {
  ...
  methods: {
    getReturnRequests() {
      this.isLoading = true;
      axios.get(this.$apiUrl + "/return_requests").then((response) => {
      ...
      this.$swal
        ...
        .then((result) => {
          if (result.value) {
            ...
            axios
              .post(this.$apiUrl + "/return_requests/delete", postData)
              .then((response) => {
                this.isLoading = false;
