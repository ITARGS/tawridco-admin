              ...
              <div class="col-12 col-lg-6 col-md-6">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <router-link
                      :to="{ name: 'SellerProductInfo', params: { type: 'sold_out' } }"
                      class="btn btn-block btn-light-primary btn-lg btn_product_count"
                      >{{ __("more_info") }}
                    </router-link>
                  </div>
              ...
              <div class="col-12 col-lg-6 col-md-6">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <router-link
                      :to="{ name: 'SellerProductInfo', params: { type: 'low_stock' } }"
                      class="btn btn-lg btn-block btn-light-primary btn-lg btn_product_count"
                      >More Info
                    </router-link>
                  </div>
...
export default {
  ...
  methods: {
    ...
    getRecord: function () {
      ...
      this.isLoading = true;
      axios
        .get(this.$sellerApiUrl + "/dashboard")
        .then((res) => {
          vm.isLoading = false;
          let data = res.data;
          if (data.status === 1) {
            ...
            this.graphOrders.forEach((order) => {
              this.options.xaxis.categories.push(
                moment(order.order_date).format("DD-MMM")
              );
