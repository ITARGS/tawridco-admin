              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="form-group col-md-5">
                    <div class="form-group">
                      <label
                        >{{ __("category_ids") }}<i class="text-danger">*</i>
                        <small>( Ex : 100,205, 360 ) </small></label
                      >
                      <Select2
                    ...
                    <div class="form-group">
                      ...
                      >
                        <template v-if="national_id_card && national_id_card.name !== ''">
                          <label
                            >{{ __("selected_file_name") }}:- {{ __("selected_file_name")
                  ...
                  <div class="form-group col-md-12">
                    <label for="logo">
                      {{ __("logo") }} <i v-if="!id" class="text-danger">*</i></label
                    >
                    <input
                      type="file"
                      accept="image/*"
                  ...
                  <div
                    class="col-md-12"
                    v-if="id && this.$roleSeller !== this.login_user.role.name"
                  >
                    <div class="row">
                      <div class="form-group col-md-5">
                        <label class="control-label">
                          {{ __("status") }} <i class="text-danger">*</i></label
                        ><br />
                        <b-form-radio-group
                          v-model="status"
                          :options="[
                            { text: __('registered'), value: 0 },
                            { text: __('approve'), value: 1 },
                      ...
                      <div v-if="[2, 3].includes(status)" class="form-group col-md-4">
                        <label for="remark"
                          >{{ __("remark") }} <i class="text-danger">*</i></label
                        >
                        <div class="form-floating">
                          <textarea
                            ...
                            spellcheck="true"
                          ></textarea>
                          <label for="remark">{{ __("add_mark") }}</label>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-12 mb-3">
                    ...
                    <div v-if="formatted_address">
                      <span class="title font-weight-bolder"
                        ><b>{{ place_name }}</b> - {{ formatted_address }}</span
                      >
                    </div>
                  </div>
                </div>
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="form-group col-md-3">
                    <div class="form-group">
                      <label>
                        {{ __("account_number") }}<i class="text-danger">*</i></label
                      >
                      <input
                        type="number"
                        class="form-control"
                  ...
                  <div class="form-group col-md-3">
                    <div class="form-group">
                      <label
                        >{{ __("bank_ifsc_code") }}<i class="text-danger">*</i></label
                      >
                      <input
                        type="text"
                        class="form-control"
                  ...
                  <div class="form-group col-md-3">
                    <div class="form-group">
                      <label>
                        {{ __("bank_account_name") }}<i class="text-danger">*</i></label
                      >
                      <input
                        type="text"
              ...
              <div class="card-body">
                <div class="row">
                  <div class="form-group col-md-3">
                    <div class="form-group">
                      <label class="control-label">
                        {{ __("require_product_approval") }}</label
                      ><br />
                      <b-form-radio-group
                  ...
                  <div class="form-group col-md-3">
                    <div class="form-group">
                      <label class="control-label">
                        {{ __("view_customer_details") }}</label
                      ><br />
                      <b-form-radio-group
