            ...
            <div class="card">
              <div class="card-header">
                <h4>
                  ...
                  ><template v-else>{{ __("create") }}</template> {{ __("product") }}
                </h4>
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <input
                      type="text"
                      class="form-control"
                      :placeholder="__('enter_product_name_en')"
                      v-model="name_en"
                      v-on:keyup="createSlug"
                      required
                    />
                  </div>
                  <div class="col-md-6">
                    ...
                    <input
                      type="text"
                      class="form-control"
                      :placeholder="__('enter_product_name_ar')"
                      v-model="name_ar"
                      v-on:keyup="createSlug"
                      required
                    />
                  ...
                  <div class="col-md-6">
                    ...
                    <input
                      type="text"
                      class="form-control"
                      :placeholder="__('enter_product_slug')"
                      v-model="slug"
                    />
                  </div>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <label
                        >{{ __("description_en") }} <i class="text-danger">*</i></label
                      >
                      <editor
                        :placeholder="__('enter_product_description_en')"
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <label
                        >{{ __("description_ar") }} <i class="text-danger">*</i></label
                      >
                      <editor
                        :placeholder="__('enter_product_description_ar')"
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="other_images">{{
                        __("other_images_of_the_product")
                      }}</label>
                      ...
                      <div
                        class="file-input-div bg-gray-100"
                        @click="$refs.file_other_images.click()"
                ...
                <div class="col-md-6">
                  <div class="row">
                    <div class="form-group col-md-6">
                      <label>{{ __("type") }} <i class="text-danger">*</i></label
                      ><br />
                      <b-form-radio-group
                        v-model="type"
                        :options="[
                    ...
                    <div class="form-group col-md-6">
                      <label class="control-label"
                        >{{ __("stock_limit") }} <i class="text-danger">*</i></label
                      ><br />
                      <b-form-radio-group
                      ...
                      <div class="col-md-4">
                        <div class="form-group loose_div">
                          <label for="discounted_price"
                            >{{ __("discounted_price") }} ( {{ $currency }} ):</label
                          >
                          <input
                            type="number"
                            step="any"
                          ...
                          />
                          <span
                            v-if="input.validationErrorDiscountedPriceLoose"
                            class="error"
                ...
                <div class="row">
                      ...
                      <div class="col-md-5">
                        <div class="form-group">
                          ...
                          <input
                            type="text"
                            class="form-control"
                            :placeholder="__('fssai_lic_no')"
                            v-model="fssai_lic_no"
                            @input="validateFSSAINumber"
                          />
                          <p style="color: red" v-if="validationMessage">
                            {{ validationMessage }}
                          </p>
                  ...
                  <div class="col-md-6">
                    <div class="row">
                      ...
                      >
                        <div class="form-group">
                          <label for="till_status">{{ __("till_which_status") }} </label>
                          <i class="text-danger">*</i>
                          <br />
                          <select
                            id="till_status"
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          />
                          <span class="text text-primary">{{
                            __("keep_blank_if_no_such_limit")
                          }}</span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <template v-else>
                      <div class="form-group">
                        <label class="control-label">{{ __("product_status") }}</label
                        ><br />
  ...
  methods: {
    ...
    variantImagesChanges(index) {
      ...
      if (this.type === "packet") {
        ...
        for (
          var i = 0;
          i < this.$refs["packet_variant_images_" + index][0].files.length;
          i++
        ) {
          let image = {};
    ...
    getSeller() {
      if (this.seller_id !== 0 && this.seller_id !== "" && !this.id) {
        ...
        axios
          .get(this.$apiUrl + "/sellers/edit/" + this.seller_id, {
            params: param,
          })
          .then((response) => {
            (this.isLoading = false),
              (this.require_products_approval =
                response.data.data.require_products_approval);
    ...
    getBrands() {
      this.isLoading = true;
      axios.get(this.$apiUrl + "/products/brands/get").then((response) => {
        this.isLoading = false;
        let data = response.data;
    ...
    getCountries() {
      this.isLoading = true;
      axios.get(this.$apiUrl + "/countries/active").then((response) => {
        this.isLoading = false;
        let data = response.data;
    ...
    getTags() {
      this.isLoading = true;
      axios.get(this.$apiUrl + "/products/tags").then((response) => {
        this.isLoading = false;
        let data = response.data;
        this.tags = data.data;
      });
    ...
    getOrderStatus() {
      ...
      axios.get(this.$apiUrl + "/order_statuses").then((response) => {
        ...
        this.order_status = data.data.filter(
          (status) => !statusesToRemoveIds.includes(status.id)
        );
      });
    },
    validateFSSAINumber() {
      ...
      axios
        ...
        .then((response) => {
          ...
          if (data.status === 1) {
            ...
            this.description_en = this.record.description_en;
            this.description_ar = this.record.description_ar;
    ...
    saveRecord: function () {
      ...
      if (this.type === "packet") {
        for (let i = 0; i < this.inputs.length; i++) {
          ...
          formData.append(
            "packet_price[]",
            this.inputs[i].packet_price != undefined ? this.inputs[i].packet_price : 0
          );
          formData.append(
            "discounted_price[]",
          ...
          formData.append(
            "packet_stock[]",
            this.inputs[i].packet_stock != undefined ? this.inputs[i].packet_stock : 0
          );
          formData.append(
            "packet_stock_unit_id[]",
            this.inputs[i].packet_stock_unit_id != undefined
              ? this.inputs[i].packet_stock_unit_id
              : 0
          );
          formData.append(
            "packet_status[]",
            this.inputs[i].packet_status != undefined ? this.inputs[i].packet_status : 0
          );

          for (
            var j = 0;
            j < this.$refs["packet_variant_images_" + i][0].files.length;
            j++
          ) {
      ...
      if (this.type === "loose") {
        for (let i = 0; i < this.inputs.length; i++) {
          ...
          formData.append(
            "loose_price[]",
            this.inputs[i].loose_price != undefined ? this.inputs[i].loose_price : 0
          );
          formData.append(
            "loose_discounted_price[]",
            this.inputs[i].loose_discounted_price != undefined
              ? this.inputs[i].loose_discounted_price
              : 0
          );
          formData.append(
            "packet_stock[]",
      ...
      formData.append(
        "loose_stock",
        this.loose_stock != undefined ? this.loose_stock : 0
      );
      formData.append(
        "loose_stock_unit_id",
        this.loose_stock_unit_id != undefined ? this.loose_stock_unit_id : 0
      );
