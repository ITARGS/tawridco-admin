              ...
              <b-row class="mb-2">
                <b-col md="3">
                  ...
                  <span class="text-danger d-block font-size-13">{{
                    __("select_a_product_for_update_product_rating_list")
                  }}</span>
                </b-col>
              </b-row>
              ...
              <div class="card-body">
                ...
                >
                  ...
                  <template #cell(images)="row">
                    <a
                      v-for="(image, index) in row.item.images"
                      :key="index"
                  ...
                  <template #cell(actions)="row">
                    ...
                    <button
                      ...
                      @click="deleteDietary(row.index, row.item.id)"
                      v-b-tooltip.hover
                      :title="__('delete')"
                    >
                ...
                <b-row>
                  ...
                  <b-col md="4" class="my-1" offset-md="6">
                    <label>{{ __("total_ratings") }} :- {{ totalRows }} , </label>
                    <label
                      >{{ __("average_rating") }}:
                      {{ calculateAverageRating().toFixed(2) }}</label
                    >
                    <b-pagination
                      v-model="currentPage"
...
export default {
  ...
  methods: {
    ...
    renderStarRating(rate) {
      ...
      const ratingString =
        starIconFilled.repeat(filledStars) + starIconBlank.repeat(blankStars);
    ...
    getRecords() {
      ...
      axios
        .get(this.$baseUrl + "/customer/products/ratings_list", {
          params: param,
        })
        .then((response) => {
    ...
    getProducts() {
      axios.get(this.$apiUrl + "/products/active").then((response) => {
