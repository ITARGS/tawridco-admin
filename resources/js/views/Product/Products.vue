          ...
          <div class="card">
            ...
            <div class="card-body">
                  ...
                  >
                    <b-dropdown-item href="javascript:void(0);" @click="multipleDelete"
                      ><span class="text-danger" style="font-weight: bold"
                        ...
                        {{ __("delete_selected_products") }}</span
                      >
                    </b-dropdown-item>
                  </b-dropdown>
                </div>
              ...
              <b-row class="mb-2">
                ...
                <template v-if="$roleSeller == login_user.role.name">
                  <input type="hidden" v-model="isSellerRole" />
                </template>
                <template v-else>
                  <b-col md="3">
                ...
                <b-col
                  md="3"
                  v-bind:class="$roleSeller == login_user.role.name ? 'offset-3' : ''"
                >
                ...
                >
                  ...
                  <template #cell(image)="row">
                    <img
                      ...
                      @click="openLightbox($storageUrl + row.item.image)"
                      alt="Image"
                      height="50"
                    />
                      ...
                      <template v-if="$roleSeller == login_user.role.name">
                        ...
                        <router-link
                          :to="{
                            ...
                            params: { id: row.item.id, record: row.item, clone: true },
                          }"
                          class="btn btn-success btn-sm"
                          v-if="$can('product_update')"
                          v-b-tooltip.hover
        ...
        this.$swal
          ...
          .then((result) => {
            if (result.value) {
              ...
              axios
                .post(this.$apiUrl + "/products/multiple_delete", postData)
                .then((response) => {
                  this.isLoading = false;
                  let data = response.data;
                  //this.products.splice(index, 1)
