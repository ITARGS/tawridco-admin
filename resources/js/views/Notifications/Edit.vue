    ...
    <form ref="my-form" @submit.prevent="saveRecord">
      ...
      <div class="row">
        ...
        <div class="form-group" v-if="type === 'user'">
          <label>
            {{ __("customer")
            }}<small>( Ex : 100,205, 360 <comma separated="">)</comma></small></label
          >
          <Select2
            v-model="type_ids"
        ...
        <div class="form-group" v-if="type === 'category'">
          ...
          <select
            ...
            required
          >
            <option>{{ __("select_categories") }}</option>
        ...
        <div
          class="form-group"
          v-if="(include_image === true && id) || include_image === true"
        >
          <input
            type="file"
      ...
      axios
        ...
        .catch((error) => {
          ...
          if (error.message) {
            ...
            error.request.statusText !== "" &&
            typeof error.request.statusText !== "undefined"
          ) {
