      ...
      <section class="row">
                      ...
                      <div class="row d-flex flex-column justify-content-center">
                        ...
                        >
                          <div class="stats-icon-big blue">
                            <img
                              :src="
                                $baseUrl + '/assets/images/dashboard/Total_Orders.svg'
                              "
                            />
                          </div>
                        </div>
                      ...
                      <div class="row">
                        ...
                        >
                          <div class="stats-icon-big sky">
                            <img
                              :src="
                                $baseUrl + '/assets/images/dashboard/Total_Customers.svg'
                              "
                            />
                          </div>
                        </div>
          ...
          <div class="col-12 col-lg-8 col-md-8 col-8">
            <div class="card h-95">
              <div class="card-header">
                ...
                <p>
                  {{ __("total_sale_in_last_week") }} ({{ __("month") }}:
                  {{ currentMonth }})
                </p>
              </div>
              <div class="card-body">
              ...
              <div class="col-12 col-lg-6 col-md-6">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <router-link
                      :to="{ name: 'ProductInfo', params: { type: 'packet_products' } }"
              ...
              <div class="col-12 col-lg-6 col-md-6">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <router-link
                      :to="{ name: 'ProductInfo', params: { type: 'loose_products' } }"
              ...
              <div class="col-12 col-lg-6 col-md-6">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <router-link
                      :to="{ name: 'ProductInfo', params: { type: 'sold_out' } }"
                      class="btn btn-block btn-light-primary btn-lg btn_product_count"
                      >{{ __("more_info") }}
                    </router-link>
                  </div>
              ...
              <div class="col-12 col-lg-6 col-md-6">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <router-link
                      :to="{ name: 'ProductInfo', params: { type: 'low_stock' } }"
                      class="btn btn-lg btn-block btn-light-primary btn-lg btn_product_count"
                    >
                      {{ __("more_info") }}
                    </router-link>
        ...
        <div class="row">
          ...
          <div
            ...
            v-for="status in record.status_order_count"
          >
            <div class="card">
              <div class="card-body px-3 py-4-5">
                <div class="row">
                  <div class="col-md-4">
                    <div
                      ...
                      class="stats-icon payment_pending"
                    >
                      <img
                        :src="$baseUrl + '/assets/images/dashboard/Payment_Pending.svg'"
                      />
                    </div>
                    <div
                      v-else-if="status.status == $received"
                      class="stats-icon received"
                    >
                      <img :src="$baseUrl + '/assets/images/dashboard/Received.svg'" />
                    </div>
                    <div
                      v-else-if="status.status == $processed"
                      class="stats-icon processed"
                    >
                    ...
                    <div
                      v-else-if="status.status == $outForDelivery"
                      class="stats-icon outForDelivery"
                    >
                      <img
                        :src="$baseUrl + '/assets/images/dashboard/Out_For_Delivery.svg'"
                      />
                    </div>
                    <div
                      v-else-if="status.status == $delivered"
                      class="stats-icon delivered"
                    >
                    ...
                    <div
                      ...
                      class="stats-icon cancelled"
                    >
                      <img :src="$baseUrl + '/assets/images/dashboard/Cancelled.svg'" />
                    </div>

                    <div
                      v-else-if="status.status == $returned"
                      class="stats-icon returned"
                    >
                  ...
                  <div class="col-md-8">
                    ...
                    <h6
                      v-if="status.status == $outForDelivery"
                      class="text-muted font-semibold"
                    >
                      {{ __("outForDelivery") }}
                    </h6>
                    <h6
                      v-if="status.status == $delivered"
                      class="text-muted font-semibold"
                    >
                      {{ __("delivered") }}
                    </h6>
                  ...
                  <b-col md="3">
                    ...
                    <div class="d-flex justify-content-center align-items-center">
                      ...
                      <button
                        class="btn btn-sm btn-danger ml-1"
                        @click="
                          (deliveryDateRange.startDate = null),
                            (deliveryDateRange.endDate = null),
                            getOrders()
                        "
                      >
                        {{ __("clear") }}
...
export default {
  ...
  methods: {
    ...
    setSellerWalletTransaction: function () {
      ...
      this.isLoading = true;
      axios
        .get(this.$apiUrl + "/set_seller_wallet_transaction")
        .then((res) => {
          vm.isLoading = false;
          let data = res.data;
          if (data.status === 1) {
    ...
    getLatestOrders: function () {
      ...
      let param = {
        ...
        seller: this.seller,
        status: this.status,
        startDeliveryDate: this.deliveryDateRange.startDate
          ? moment(this.deliveryDateRange.startDate).format("YYYY-MM-DD")
          : "",
        endDeliveryDate: this.deliveryDateRange.endDate
          ? moment(this.deliveryDateRange.endDate).format("YYYY-MM-DD")
          : "",
      };
      axios
      ...
      this.$swal
        ...
        .then((result) => {
          if (result.value) {
            ...
            axios.post(this.$apiUrl + "/orders/delete", postData).then((response) => {
              this.isLoading = false;
              let data = response.data;
