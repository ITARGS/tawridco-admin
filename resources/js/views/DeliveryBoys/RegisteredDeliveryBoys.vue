            ...
            >
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">
                  {{ __("new_registered_delivery_boys") }}
                </li>
              </ol>
            </nav>
          </div>
                    ...
                    <table class="table table-borderless">
                      <tr>
                        ...
                        <td class="text-center">
                          {{
                            row.item.bonus_type === 1 ? "Commission" : "Fixed/Salaried"
                          }}
                        </td>
                      </tr>
                      <tr>
        ...
        .then(async (result) => {
          if (result.value) {
            ...
            if (selectedStatus === 1 || (selectedStatus === 2 && remarks !== "")) {
              ...
              axios
                .post(this.$apiUrl + "/delivery_boys/update-status", postData)
                .then((response) => {
                  this.isLoading = false;
      ...
      this.$swal
        ...
        .then((result) => {
          if (result.value) {
            ...
            axios
              .post(this.$apiUrl + "/delivery_boys/delete", postData)
              .then((response) => {
                this.isLoading = false;
