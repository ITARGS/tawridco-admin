              ...
              >
                ...
                <span class="pull-right">
                  <router-link
                    ...
                    >{{ __("view_delivery_boys") }}</router-link
                  >
                </span>
              </div>
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="name"
                        >{{ __("name") }}<span class="text-danger text-xs">*</span></label
                      >
                      <input
                        type="text"
                        name="name"
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="other_payment_info">{{
                        __("other_payment_information")
                      }}</label>
                      <textarea
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      >
                        <template
                          v-if="
                            deliveryBoys.driving_license &&
                            deliveryBoys.driving_license.name !== ''
                          "
                        >
                          <label>
                      ...
                      <p v-if="drivingLicencevalidationerror" class="error">
                        {{ drivingLicencevalidationerror }}
                      </p>
                      <div class="row" v-if="deliveryBoys.driving_license_url">
                        <div
                          v-if="isImage(deliveryBoys.driving_license_url)"
                          class="col-md-2"
                        >
                          <img
                            class="custom-image"
                        ...
                        <div v-else class="col-md-2 mt-2">
                          ...
                          >
                            <i class="fa fa-eye"></i> {{ __("identity_card") }}Identity
                            Card</a
                          >
                        </div>
                      </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <p v-if="nationalIdentityCardvalidationerror" class="error">
                        {{ nationalIdentityCardvalidationerror }}
                      </p>
                  ...
                  >
                    <div class="d-flex justify-content-between align-content-center">
                      ...
                      <b-button-group>
                        <b-button
                          @click="getBonusSettings"
                          v-if="$deliveryBoyBonusSettings == 1"
                          type="button"
                          variant="primary"
                          size="sm"
                        >
  ...
  methods: {
    handleFileUploadLicense() {
      ...
      if (!validTypes.includes(file.type)) {
        this.drivingLicencevalidationerror =
          "Invalid file type. Please upload a JPEG, PNG, JPG, GIF, WEBP image or PDF or DOC file ";
        return;
      }
    ...
    handleFileUploadCard() {
      ...
      if (!validTypes.includes(file.type)) {
        this.nationalIdentityCardvalidationerrorv =
          "Invalid file type. Please upload a JPEG, PNG, JPG, GIF, WEBP image or PDF or DOC file ";
        return;
      }
    ...
    getBonusSettings() {
      axios.get(this.$apiUrl + "/delivery_boys/bonus_settings").then((response) => {
    ...
    changeBonusType() {
      if (this.deliveryBoys.bonus_type == 0) {
        ...
        this.deliveryBoys.bonus_percentage = this.record
          ? this.record.bonus_percentage
          : "";
        this.deliveryBoys.bonus_min_amount = this.record
          ? this.record.bonus_min_amount
          : "";
        this.deliveryBoys.bonus_max_amount = this.record
          ? this.record.bonus_max_amount
          : "";
      }
    },
    ...
    getDeliveryBoy() {
      axios
        .get(this.$apiUrl + "/delivery_boys/edit/" + this.id)
        .then((response) => {
          this.isLoading = false;
          let data = response.data;
          if (data.status === 1) {
            ...
            this.deliveryBoys.bank_account_number = this.record
              ? this.record.bank_account_number
              : "";
            ...
            this.deliveryBoys.other_payment_information = this.record
              ? this.record.other_payment_information
              : "";

            this.deliveryBoys.driving_license = "";
            this.deliveryBoys.driving_license_url = this.record
              ? this.$storageUrl + this.record.driving_license
              : "";
            this.deliveryBoys.national_identity_card = "";
            this.deliveryBoys.national_identity_card_url = this.record
