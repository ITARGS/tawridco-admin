...
<section class="invoice" id="printMe">
    <table width="100%">
        <tr>
            <td width="50%" style="text-align: left;"><h2><img src="{{ $logo_full_path }}" height="45"> {{ $appName }}
                </h2></td>
            <td width="50%" style="text-align: right;"><h2>Invoice</h2><h5 style="text-align: left;"><b>No
                        : </b>#{{ $order->order_item_id }} </h5></td>
        </tr>
        <br>
        <tr>
    ...
    <table width="100%">
        <tr>
            <td width="50%" style="text-align: left;">
                <p><span style="font-weight: bold;">Payment Method : </span> {{ strtoupper($order->payment_method) }}
                </p>
            ...
            <td width="50%" style="text-align: right;">
                <table class="product-table">
                    ...
                    <tr>
                        ...
                        <th align="right"
                            style="padding: 8px; background-color: #37a279; color: white;">{{ '= ' . $order->final_total }}</th>
                    </tr>
                    </tbody>
                </table>
            </td>
